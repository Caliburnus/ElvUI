...
function LO:CreateChatPanels()
	...
	lchattb.text:FontTemplate(E['media'].pixelFont, 10, 'OUTLINE')
	...
	rchattb.text:FontTemplate(E['media'].pixelFont, 10, 'OUTLINE')
...
function LO:CreateMinimapPanels()
	...
	configtoggle.text:FontTemplate(E['media'].pixelFont, 10, 'OUTLINE')
	configtoggle.text:SetText('C')
	configtoggle.text:SetPoint('CENTER', 2, 0)
